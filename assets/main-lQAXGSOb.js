import{V as _}from"./vue.runtime.esm-bundler-BRNTKtdd.js";import{_ as i,r,o as h,c as v,m as o,a as e,w as u,g as C}from"./index-1-5pqjkO.js";const g={name:"component-doc",components:{"element-demo0":{render:function(){const{resolveComponent:a,openBlock:s,createBlock:c}=_;return function(t,n){const l=a("ve-select");return s(),c(l,{modelValue:t.selectItems1,"onUpdate:modelValue":n[0]||(n[0]=d=>t.selectItems1=d),placeholder:"姓名"},null,8,["modelValue"])}}(),...function(){return{data(){return{selectItems1:[{value:0,label:"张三"},{value:1,label:"李四"},{value:2,label:"王二"}]}}}}()},"element-demo1":{render:function(){const{resolveComponent:a,openBlock:s,createBlock:c}=_;return function(t,n){const l=a("ve-select");return s(),c(l,{modelValue:t.selectItems1,"onUpdate:modelValue":n[0]||(n[0]=d=>t.selectItems1=d),placeholder:"姓名",width:120},null,8,["modelValue"])}}(),...function(){return{data(){return{selectItems1:[{value:0,label:"张三"},{value:1,label:"李四"},{value:2,label:"王二"}]}}}}()},"element-demo2":{render:function(){const{resolveComponent:a,openBlock:s,createBlock:c}=_;return function(t,n){const l=a("ve-select");return s(),c(l,{modelValue:t.selectItems2,"onUpdate:modelValue":n[0]||(n[0]=d=>t.selectItems2=d),"is-multiple":"",placeholder:"姓名"},null,8,["modelValue"])}}(),...function(){return{data(){return{selectItems2:[{value:0,label:"张三"},{value:1,label:"李四"},{value:2,label:"王二"}]}}}}()},"element-demo3":{render:function(){const{resolveComponent:a,openBlock:s,createBlock:c}=_;return function(t,n){const l=a("ve-select");return s(),c(l,{modelValue:t.selectItems3,"onUpdate:modelValue":n[0]||(n[0]=d=>t.selectItems3=d),placeholder:"姓名",isInput:""},null,8,["modelValue"])}}(),...function(){return{data(){return{selectItems3:[{value:0,label:"张三"},{value:1,label:"李四"},{value:2,label:"王二"}]}}}}()},"element-demo4":{render:function(){const{resolveComponent:a,openBlock:s,createBlock:c}=_;return function(t,n){const l=a("ve-select");return s(),c(l,{modelValue:t.selectItems1,"onUpdate:modelValue":n[0]||(n[0]=d=>t.selectItems1=d),placeholder:"姓名",onOnSelectChange:t.selectChange},null,8,["modelValue","onOnSelectChange"])}}(),...function(){return{data(){return{selectItems1:[{value:0,label:"张三"},{value:1,label:"李四"},{value:2,label:"王二"}]}},methods:{selectChange(a){console.log("items::",a)}}}}()}}},k={class:"content example-md-doc"},E=o("pre",null,[o("code",{class:"html"},`<template>
