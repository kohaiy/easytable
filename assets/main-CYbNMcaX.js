import{_ as v,r as l,o as m,c as h,a as n,h as e,i as d,w as u,ac as $,d as E,b as g}from"./index-ktVylMVm.js";import{V as f}from"./vue.runtime.esm-bundler-oE0CmIyJ.js";const C={},B={class:"content example-md-doc"},k=e("p",null,[d("引入 "),e("code",null,"VePagination")],-1),x=e("pre",null,[e("code",{class:"language-javascript"},`import Vue from "vue";
...
<\/script>
`)],-1);function se(t,a,o,i,s,p){const c=l("anchor"),r=l("element-demo0"),_=l("demo-block");return m(),h("section",le,[n(c,{"is-edit":"",label:"Callback Events",fileName:"callback-events.md"}),n(_,null,{source:u(()=>[n(r)]),highlight:u(()=>[de]),default:u(()=>[ue]),_:1})])}const re=v(ae,[["render",se]]),ie={name:"component-doc",components:{"element-demo0":{render:function(){const{createElementVNode:t,resolveComponent:a,createVNode:o,openBlock:i,createElementBlock:s}=f,p=t("div",{class:"mb20 bold"},"不显示页码按钮",-1),c=t("div",{class:"mt30 mb20 bold"},"调整显示顺序",-1),r=t("div",{class:"mt30 mb20 bold"},"完整布局",-1);return function(Be,ke){const b=a("ve-pagination");return i(),s("div",null,[t("div",null,[p,o(b,{total:600,layout:["total","prev","next","sizer","jumper"]})]),t("div",null,[c,o(b,{total:600,layout:["total","sizer","prev","pager","next","jumper"]})]),t("div",null,[r,o(b,{total:600,layout:["total","prev","pager","next","sizer","jumper"]})])])}}(),...function(){return{}}()}}},pe={class:"content example-md-doc"},_e=e("div",null,[e("p",null,[d("1、通过设置 "),e("code",null,"layout"),d(" 属性，改变布局。"),e("br"),d("2、"),e("code",null,"layout"),d(" 属性支持以下配置项："),e("br"),e("code",null,"total"),d("：显示总条数、"),e("code",null,"prev"),d("：显示上一页按钮、"),e("code",null,"pager"),d("：显示页码按钮、"),e("code",null,"next"),d("：显示下一页按钮、"),e("code",null,"sizer"),d("：显示每页大小设置、"),e("code",null,"jumper"),d("：显示跳转文本框")])],-1),me=e("pre",null,[e("code",{class:"html"},`<template>
    <div>
        <div>
