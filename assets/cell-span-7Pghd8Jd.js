...
<\/script>
`)],-1);function D(a,e,o,c,t,u){const r=i("anchor"),h=i("element-demo0"),p=i("demo-block");return y(),f("section",C,[l(r,{"is-edit":"",label:"footer 列合并",fileName:"cell-span.md"}),l(p,null,{source:s(()=>[l(h)]),highlight:s(()=>[_]),default:s(()=>[w]),_:1})])}const N=m(g,[["render",D]]);export{N as C};
