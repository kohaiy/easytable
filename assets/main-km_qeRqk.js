import{O as f,a as C}from"./on-footer-cell-ZCKTV_2D.js";import{E as N}from"./event-custom-option-props-h-pPHkRq.js";import{_ as v,o as g,c as b,ac as x,r as d,a,w as m,h as i}from"./index-OvRFtLym.js";import{V as h}from"./vue.runtime.esm-bundler-SqYzIWQ-.js";import"./api-tpl-XfvygVDy.js";const A={},B={class:"content example-md-doc"},E=x(`<div class="tip"><p>1、<code>eventCustomOption</code> 配置自定义事件<br> 2、支持 body、header、footer 行和列 事件自定义<br> 3、支持以下事件自定义</p><ul><li>click</li><li>dblclick</li><li>contextmen</li><li>mouseenter</li><li>mouseleave</li><li>mousemove</li><li>mouseover</li><li>mousedown</li><li>mouseup</li></ul></div><p>配置代码速览</p><pre><code>eventCustomOption: {
  // body 行事件自定义
