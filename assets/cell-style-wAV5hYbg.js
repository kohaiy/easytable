...
<\/script>
`)],-1);function w(n,e,a,i,o,c){const u=r("anchor"),f=r("element-demo0"),m=r("demo-block");return h(),y("section",C,[s(u,{"is-edit":"",label:"footer 单元格样式",fileName:"cell-style.md"}),s(m,null,{source:d(()=>[s(f)]),highlight:d(()=>[_]),default:d(()=>[F]),_:1})])}const B=p(D,[["render",w]]);export{B as C};
