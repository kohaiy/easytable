import{_ as f,o as _,c as p,ac as k,r as o,a as c,w as a,h as t,i as u}from"./index-ktVylMVm.js";import{V as b}from"./vue.runtime.esm-bundler-oE0CmIyJ.js";const y={},w={class:"content example-md-doc"},x=k('<div class="tip"><p>1、通过设置<code>columns</code> 的<code>children</code>属性，即可实现表头分组功能<br> 2、<code>children</code>属性指定需要合并的列<br> 3、表头分组功能必须指定列的<code>key</code>属性！！<br> 4、当需要固定分组的列时，只需要将 fixed 属性设置在顶层配置中即可</p></div>',1),$=[x];function g(n,e){return _(),p("section",w,$)}const D=f(y,[["render",g]]),B={name:"component-doc",components:{"element-demo0":{render:function(){const{resolveComponent:n,openBlock:e,createBlock:d}=b;return function(i,m){const l=n("ve-table");return e(),d(l,{"border-y":"",columns:i.columns,"table-data":i.tableData},null,8,["columns","table-data"])}}(),...function(){return{data(){return{columns:[{field:"col1",key:"a",title:"col1",width:"10%"},{title:"col2-col3",children:[{field:"col2",key:"b",title:"col2",width:100},{field:"col3",key:"c",title:"col3",width:110}]},{title:"col4-col5-col6",children:[{title:"col4-col5",children:[{field:"col4",key:"d",title:"col4",width:130},{field:"col5",key:"e",title:"col5",width:140}]},{title:"col6",field:"col6",key:"f",width:140}]},{field:"col7",key:"g",title:"col7",width:150},{field:"col8",key:"h",title:"col8",width:160}],tableData:[]}},methods:{initTableData(){let n=[];for(let e=0;e<6;e++)n.push({rowKey:e,col1:e,col2:e,col3:e,col4:e,col5:e,col6:e,col7:e,col8:e});this.tableData=n}},created(){this.initTableData()}}}()}}},v={class:"content example-md-doc"},E=t("div",null,[t("p",null,[u("1、通过设置"),t("code",null,"children"),u("指定当前合并的列")])],-1),C=t("pre",null,[t("code",{class:"html"},`<template>
