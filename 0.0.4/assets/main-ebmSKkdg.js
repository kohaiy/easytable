import{R as f}from"./row-style-option-props-0sVEZ18E.js";import{_ as y,o as g,c as b,g as v,r as o,a,w as u,m as n,p as m}from"./index-LkC73w2Y.js";import{V as w}from"./vue.runtime.esm-bundler-GrE_vstH.js";import"./api-tpl-MGzMLg1Q.js";const C={},k={class:"content example-md-doc"},A=v('<div class="tip"><p>1、通过属性<code>rowStyleOption</code>设置行的样式<br> 2、通过属性<code>stripe=true</code>开启斑马纹<br> 3、通过属性<code>hoverHighlight=true</code>开启行 hover 高亮效果。默认开启<br> 4、通过属性<code>clickHighlight=true</code>开启行 click 高亮效果。默认开启</p></div>',1),N=[A];function B(e,d){return g(),b("section",k,N)}const $=y(C,[["render",B]]),E={name:"component-doc",components:{"element-demo0":{render:function(){const{resolveComponent:e,createVNode:d,openBlock:t,createElementBlock:i}=w;return function(r,s){const l=e("ve-table");return t(),i("div",null,[d(l,{"row-style-option":r.rowStyleOption,columns:r.columns,"table-data":r.tableData},null,8,["row-style-option","columns","table-data"])])}}(),...function(){return{data(){return{rowStyleOption:{stripe:!0},columns:[{field:"",key:"a",title:"",width:50,align:"center",renderBodyCell:({row:e,column:d,rowIndex:t},i)=>++t},{field:"name",key:"b",title:"Name",width:200,align:"left"},{field:"hobby",key:"c",title:"Hobby",width:300,align:"left"},{field:"address",key:"d",title:"Address",width:"",align:"left"}],tableData:[{rowKey:1001,name:"John",date:"1900-05-20",hobby:"coding",address:"No.1 Century Avenue, Shanghai"},{rowKey:1002,name:"Dickerson",date:"1910-06-20",hobby:"coding",address:"No.1 Century Avenue, Beijing"},{rowKey:1003,name:"Larsen",date:"2000-07-20",hobby:"coding and coding repeat",address:"No.1 Century Avenue, Chongqing"},{rowKey:1004,name:"Geneva",date:"2010-08-20",hobby:"coding and coding repeat",address:"No.1 Century Avenue, Xiamen"},{rowKey:1005,name:"Jami",date:"2020-09-20",hobby:"coding and coding repeat",address:"No.1 Century Avenue, Shenzhen"}]}}}}()}}},K={class:"content example-md-doc"},S=n("div",null,[n("p",null,[m("通过属性"),n("code",null,"stripe"),m("开启斑马纹")])],-1),H=n("pre",null,[n("code",{class:"html"},`<template>
    <div>
